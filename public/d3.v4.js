...
function brush$1(dim) {
  ...
  function brush(group) {
    ...
    //     <polygon id="Path-6" fill="#B3BBD3" points="0 0 0 12.8274 2 15 4 12.8274 4 0"></polygon>
    // </g>
  ...
  function redraw() {
    ...
    if (selection) {
      ...
      group.selectAll(".handle")
          ...
          //   const value  =  d.type[d.type.length - 1] === "e" ? selection[1][0] - handleSize / 2 : selection[0][0] - handleSize / 2;
          //   console.log(d.type)
